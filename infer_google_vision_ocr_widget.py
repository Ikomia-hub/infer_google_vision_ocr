...
from infer_google_vision_ocr.infer_google_vision_ocr_process import InferGoogleVisionOcrParam
...
# --------------------
class InferGoogleVisionOcrWidget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = InferGoogleVisionOcrParam()
        else:
...
# --------------------
class InferGoogleVisionOcrWidgetFactory(dataprocess.CWidgetFactory):

    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        # Set the algorithm name attribute -> it must be the same as the one declared in the algorithm factory class
        self.name = "infer_google_vision_ocr"

    def create(self, param):
        # Create widget object
        return InferGoogleVisionOcrWidget(param, None)
